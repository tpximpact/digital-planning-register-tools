...
import { bopsShowEndpointToOdp } from './application'
...
export const bopsSearchEndpointToOdp = (
  ...
  if (!Value.Check(BopsSearchEndpointSchema, input)) {
    ...
    throw new Error('Invalid BopsSearchEndpoint schema')
  }
  ...
  const convertedApplications = (data ?? [])
    .map((application) => bopsShowEndpointToOdp(application))
    .filter((application) => {
      const valid =
  ...
  data: [
    {
      ...
      data: {
        application: {
          reference: '28-99600-HMVI',
          stage: 'validation',
          status: 'returned',
          publishedAt: '2014-12-22T21:12:55.303Z'
        },
        localPlanningAuthority: {
          publicCommentsAcceptedUntilDecision: true
        },
        submission: {
          submittedAt: '2014-12-21T21:12:54.903Z'
        },
        validation: {
          receivedAt: '2014-12-21T21:12:55.103Z',
          validatedAt: '2014-12-22T21:12:55.103Z',
          isValid: false
        },
        caseOfficer: {
          name: 'Casey Officer'
      ...
      files: [
        {
          ...
          url: 'https://gleeful-cell.cymru',
          metadata: {
            size: {
              bytes: 69271428
            },
            mimeType: 'image/jpeg',
            createdAt: '2015-01-03T12:59:46.449Z',
            submittedAt: '2015-02-16T10:04:34.060Z',
            validatedAt: '2015-02-28T08:13:15.882Z',
            publishedAt: '2015-03-05T06:51:09.845Z'
          }
        },
        {
          id: 1424165576753,
          ...
          thumbnailUrl: 'https://loremflickr.com/640/480?lock=1725251442442240',
          url: 'https://deep-pitching.co.uk/',
          metadata: {
            size: {
              bytes: 43915998
            },
            mimeType: 'application/pdf',
            createdAt: '2015-02-17T09:32:56.753Z',
            submittedAt: '2015-02-21T05:36:08.346Z',
            validatedAt: '2015-02-27T08:45:09.732Z',
            publishedAt: '2015-03-01T22:33:38.387Z'
          }
        },
        {
          id: 1425780609078,
          ...
          url: 'https://buzzing-cascade.nhs.uk',
          metadata: {
            size: {
              bytes: 99774121
            },
            mimeType: 'font/woff',
            createdAt: '2015-03-08T02:10:09.078Z',
            submittedAt: '2015-03-08T19:00:26.113Z',
            validatedAt: '2015-03-08T20:02:54.016Z',
            publishedAt: '2015-03-08T20:10:41.707Z'
          }
        },
        {
          id: 1421850470671,
          name: 'yippee_unbearably.shtml',
          association: 'application',
          type: ['hedgerowsInformation.plantingDate', 'photographs.existing'],
          thumbnailUrl: 'https://loremflickr.com/640/480?lock=6159427084222464',
          url: 'https://all-hall.name/',
          metadata: {
            size: {
              bytes: 98487281
            },
            mimeType: 'application/gzip',
            createdAt: '2015-01-21T14:27:50.671Z',
            submittedAt: '2015-02-06T20:25:29.070Z',
            validatedAt: '2015-02-16T02:48:05.162Z',
            publishedAt: '2015-03-04T09:00:22.859Z'
          }
        },
        {
          id: 1423882269722,
          name: 'rear_beside.ico',
          association: 'application',
          type: [
            'elevations.proposed',
            'otherDocument',
          ...
          thumbnailUrl: 'https://picsum.photos/seed/QZbxur4bS/640/480',
          url: 'https://wonderful-deduction.nhs.uk',
          metadata: {
            size: {
              bytes: 40749254
            },
            mimeType: 'audio/webm',
            createdAt: '2015-02-14T02:51:09.722Z',
            submittedAt: '2015-02-25T11:48:52.507Z',
            validatedAt: '2015-02-26T16:55:09.513Z',
            publishedAt: '2015-02-27T06:03:09.365Z'
          }
        }
      ],
      submission: {
        ...
        data: {
          ...
          proposal: {
            ...
            description:
              'Nisi commodo astrum. Vitium tamdiu armarium conitor subseco nobis tumultus aureus. Libero arma arguo vulnero candidus appositus carcer sum.\nAbsum aurum cohibeo sunt traho pecus facilis asporto uxor. Antea valde ager tenus deporto nisi animus aperte. Cuius vita ocer charisma cito timor angustus degusto nostrum.\nCattus chirographum video. Voluptate cervus titulus aegre cibus deprimo. Validus pauci vestigium aeger socius corrupti demo.\nVelum depraedor tricesimus cribro sed casus occaecati audacia. Tricesimus demergo cotidie commodo aveho. Argumentum adsidue beatae.\nAdsidue caste tumultus claudeo audeo vigilo sursum sumo explicabo. Ducimus comis dolor minima adimpleo defaeco depono defaeco subvenio. Viscus ars baiulus solio subvenio usitas.',
            boundary: {
              site: {
                type: 'Feature',
                geometry: {
        ...
        responses: [
          ...
          {
            question:
              'Which of these best describes your interest in the land?',
            responses: [
              {
                value: 'Sole owner'
              }
      ...
      metadata: {
        organisation: 'BOPS',
        id: '1234',
        generatedAt: '2025-09-30T00:34:15.312Z',
        submittedAt: '2014-12-21T21:12:54.903Z',
        schema:
