...
import { PostSubmissionDocumentsEndpoint } from '@dpr/odp-schemas/types/schemas/postSubmissionApplication/implementation/documents/index.ts'
...
describe('bopsDocumentsEndpointToOdp conversion', () => {
  describe('with results', () => {
    it('converts to a valid response successfully', () => {
      ...
      expect(Value.Check(PostSubmissionDocumentsEndpoint, after)).toBe(true)
    })
    describe('searchParams', () => {
      it('handles missing searchParams', () => {
        const conversion = bopsDocumentsEndpointToOdp(
          before,
          {} as PostSubmissionDocumentsSearchParams,
          { code: 200, message: 'OK' }
        )
  ...
  describe('with no results', () => {
    it('converts to a valid response successfully', () => {
      ...
      expect(Value.Check(PostSubmissionDocumentsEndpoint, conversion)).toBe(
        true
      )
    })
    describe('searchParams', () => {
